      ...
      <div className="flex items-center h-8 border-b shrink-0 bg-background">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full h-7 pl-7 pr-3 text-xs bg-transparent outline-none placeholder:text-muted-foreground"
            value={search}
        ...
        <div className="w-52 flex flex-col shrink-0 bg-muted/40 border-r overflow-hidden">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1 flex-wrap">
                      ...
                      <span
                        className="text-[9px] px-1 rounded shrink-0 font-medium leading-tight"
                        style={{ backgroundColor: conn.color + "28", color: conn.color }}
                      >
                        {conn.type === "sqlite" ? "file" : "local"}
                      </span>
                    </div>
                    <div className="text-[10px] text-muted-foreground truncate leading-tight italic">
          ...
          {connectError && (
            <div className="mx-2 mb-1 px-2 py-1.5 rounded bg-destructive/10 border border-destructive/20">
              ...
              <button onClick={() => setConnectError(null)} className="text-[10px] text-muted-foreground underline mt-0.5">
                Dismiss
              </button>
            </div>
          )}
          ...
          {/* Footer */}
          <div className="border-t px-1.5 py-1.5 space-y-0.5">
